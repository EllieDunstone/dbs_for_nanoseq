...
```{r read DNV table}
dataset <- read.table(file = "/Users/ed4/Documents/phd/chemo_project/BotSeq/WP4/KCL_organoid_work/wp4_2530_20230127/data/dbs_calls.csv", sep = ",", stringsAsFactors = F, header = T)
```
...
for(k in 1:length(samples)) {
  ...
  ggsave(filename = paste("/Users/ed4/Documents/phd/chemo_project/BotSeq/WP4/KCL_organoid_work/wp4_2530_20230127/data/DBS_spectra/DBS78_",samples[k],"_spectrum.pdf",sep = ""), height = 4, width = 10, plot = dnv_grob_plot)
...
```{r output matrix}
write.table(dbs_matrix, "/Users/ed4/Documents/phd/chemo_project/BotSeq/WP4/KCL_organoid_work/wp4_2530_20230127/data/dbs_mutation_matrix.tsv", sep = "\t")
